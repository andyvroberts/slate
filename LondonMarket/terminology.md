...
The discrimination factors result in a premium that allows the insurer to cover its costs and make a profit.  

### Financial Risk (risk category)
...
### Frequency
How often a risk may happen.  

### Fundamental Risk (risk category)
...
For example, a werehouse fire is a peril.  But the fact that sprinklers are not installed is a hazard which means that the fire has a greater effect.  

With regard to a Peril, examples of the hazards that can be linked with them are:
| Peril | Hazard |
|--|--|
...
### Insurable Interest (risk feature)
...
Applying this statistical law to insurance, enables the insurer to confidently predict the final cost of claims within a given (underwriting) year.  
...
### Non-Financial Risk (risk category)
...
### Peril
If a risk event occurs, a peril may give rise to a loss.  
For example, a fire, flood, explosion, lightening, collision, dishonesty.  
However, perils may be named as a cause, but in the majority, a peril does not result in a loss as claims are not made by the every insured in a pool.  
...
An insurer who gathers many small individual sums of money from those who want to be pretected from similar kinds of perils, sets itself up to operate a pool.  Insureres operate many separate pools for each different class of insurance they underwrite.  
...
Non-Financial, Speculative and Fundamental risks cannot be insured.
