...
### Endorsement
Usually some change to the insured risk/liability, where the insurer must be advised of the change.  
For example, an increase in the value of a property.  
...
### Fulfilment
When an insurance contract has been fully performed.  
...
For insurance contracts, the duty of disclosure of material facts sometimes ends at the inception date.  There is no requirement for the insured to declare material facts, unless they affect the policy cover.  
...
### Risk Category
The 6 types risk categories, used to demonstrate what is and what is not insurable.  See the [Risk](#risk) section above.  
